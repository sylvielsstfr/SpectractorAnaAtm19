...
# Image output
image_dir="allimgpng_cinestarskybkg"
image_name="starbkgimg"
padding=4
...
if __name__ == "__main__":
    ...
    for idx in np.arange(Nobs):
        ...
        if 1:
            ...
            img=plt.imshow(data,origin="lower",cmap="jet",vmin=vmin2,vmax=vmax2,norm=norm,aspect='equal')
            plt.colorbar(img)
